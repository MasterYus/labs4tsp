...
istream& operator >>(istream& in, Ocean& o) {
	cout << "¬ведите название океана: ";
	in >> o.name;
	cout << "¬ведите местоположение океана: ";
	in >> o.location;
	cout << "¬ведите площадь поверхности океана в кв. км: ";
	in >> o.area;
	cout << "¬ведите глубину океана в метрах: ";
	in >> o.depth;
	return in;
}
